...
export default function Spacer() {
    return (
        <div className='spacer'>
            {/* <div><img src={instagram} alt='background-img'></img></div>
            <div><img src={twitter} alt='background-img'></img></div>
            <div><img src={cnn} alt='background-img'></img></div>
            <div><img src={facebook} alt='background-img'></img></div> */}
        </div>
    )
}
